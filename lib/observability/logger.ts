 ...
 * best-effort URL-credential scrubbing for DB/Redis URLs. Never log full
 * upstream bodies through this channel.
 */
...
export function logEvent(stage: string, fields: Record<string, LogField>): void {
  const safe = redactFields(fields, secretValuesFrom());
